...
const Header = () => {
  return (
    <header className="bg-[#01473e] sticky top-[0px] w-full z-10 text-white py-4 px-24 mb-8 flex flex-row justify-between items-center">
      <div className="logo flex items-center gap-2 m-0">
        <svg
          width="30px"
          height="30px"
          viewBox="0 0 24 24"
      ...
      <div className="categories m-0">
        <select
          name=""
          id=""
          className="cursor-pointer font-bold text-[14px] text-[#01473e] p-2 rounded-lg bg-white"
        >
